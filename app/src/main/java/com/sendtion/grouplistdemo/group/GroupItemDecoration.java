...
public class GroupItemDecoration<Group, Child> extends RecyclerView.ItemDecoration {
    ...
    private Map<Integer, Group> mGroup = new HashMap<>();
     ...
     * @param parent RecyclerView
     */
    private void onDrawGroup(Canvas c, RecyclerView parent) {
     ...
     * @param parent RecyclerView
     */
    private void onDrawOverGroup(Canvas c, RecyclerView parent) {
     ...
     */
    private void getItemOffsets(Rect outRect, View view, RecyclerView parent, int adapterPosition) {
     ...
     */
    private Group getCroup(int position) {
        while (position >= 0) {
